...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="messages.entrynew.title"/></title>
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1><spring:message code="messages.entrynew.greeting"/></h1>
        <p><spring:message code="messages.entrynew.info"/></p>
        <p>
            <a class="btn btn-success btn-lg" href="${pageContext.request.contextPath}/overview.htm" id="overview"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Home</a>
        </p>
      </div>
    </div>

    <div class="container">
      <form action="${pageContext.request.contextPath}/entryNew.htm" method="POST" commandName="overview">
         ...
         <div class="form-group">
            ...
            <textarea class="form-control" rows="6" id="entrySummary" name="summary" required><c:out value="${entry.summary}"></c:out></textarea>
         </div>
